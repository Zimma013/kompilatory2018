...
void Scanner::scannerInit(FILE* s) {
	buffer = new Buffer(s, true);
	Init();
}
...
void Scanner::Init() {
	...
	keywords.set(L"case", 9);
	keywords.set(L"end", 10);
	keywords.set(L"program", 11);
	keywords.set(L"label", 15);
	keywords.set(L"const", 17);
	keywords.set(L"type", 18);
	keywords.set(L"var", 19);
	keywords.set(L"procedure", 20);
	keywords.set(L"function", 21);
	keywords.set(L"begin", 23);
	keywords.set(L"array", 25);
	keywords.set(L"of", 28);
	keywords.set(L"packed", 29);
	keywords.set(L"goto", 31);
	keywords.set(L"while", 32);
	keywords.set(L"do", 33);
	keywords.set(L"repeat", 34);
	keywords.set(L"until", 35);
	keywords.set(L"for", 36);
	keywords.set(L"to", 37);
	keywords.set(L"downto", 38);
	keywords.set(L"if", 39);
	keywords.set(L"then", 40);
	keywords.set(L"else", 41);
	keywords.set(L"with", 42);
	keywords.set(L"nil", 43);
	keywords.set(L"not", 44);
	keywords.set(L"in", 51);
	keywords.set(L"or", 52);
	keywords.set(L"div", 55);
	keywords.set(L"mod", 56);
	keywords.set(L"and", 57);
	keywords.set(L"record", 58);
	keywords.set(L"set", 59);
	keywords.set(L"file", 60);
...
Token* Scanner::NextToken() {
	...
	switch (state) {
		...
		case 15:
			...
			else if (ch == L'.') {apx++; AddCh(); goto case_17;}
		...
		case 17:
			case_17:
			if ((ch >= L'0' && ch <= L'9')) {apx = 0; AddCh(); goto case_4;}
			else if (ch == L'.') {apx++; AddCh(); goto case_3;}
			else {goto case_0;}
		case 18:
			{t->kind = 12; break;}
		case 19:
